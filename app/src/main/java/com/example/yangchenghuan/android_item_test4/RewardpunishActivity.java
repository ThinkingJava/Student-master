...
private ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rewardpunish);
    ...
    private void setData(){
        ...
        JSONObject jsonObject=application.getRewardMessage();
        try {
            list=(ArrayList<List<String>>)jsonObject.get("reward");
            Log.d("RewardActivity",list.toString());
        }catch (Exception e){
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View view = View.inflate(RewardpunishActivity.this, R.layout.simple_reward_item, null);
